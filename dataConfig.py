...
# Вешать ли вместе с ролью мута штатный тайм-аут Discord.
# Роль держится на правах каналов, и её можно обойти: забыли настроить новый
# форум, другая роль явно разрешает писать, кто-то поправил права руками.
# Тайм-аут таких дыр не имеет, он работает на уровне платформы. Ограничение
# Discord - максимум 28 дней, для более долгих мутов остаётся только роль
MOD_MUTE_TIMEOUT = True
...
# Потолок времени для рейтингов
# 0 - показывать всех
PLAYER_TOP_MAX_YEARS = 4

PLAYER_TOP_SKIP_GRANTED = True
