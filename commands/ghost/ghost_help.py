...
SHIFTS = (
    ...
    "Передумал по ходу раунда - правится кнопкой ✏️."
)

BUTTONS = (
    "⏹️ **Завершить** - спросит время окончания\n"
    "📢 **Оповестить о действии** - у игоста, пишет в ветку и в базу\n"
    "✏️ **Ивент** - у игоста, меняет ивент на раунд, пока смена идёт\n"
...
RULES = (
    ...
    "Ивент правится только до завершения смены, правка видна в карточке и в ветке.\n"
